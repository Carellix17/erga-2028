...
const SUBJECT_COLORS: SubjectColor[] = [ {
 key:"storia", accent:"hsl(18 45% 45%)",
 label:"Storia",
 ...
 key:"matematica", accent:"hsl(210 36% 42%)",
 label:"Matematica",
 ...
 key:"economia", accent:"hsl(38 55% 36%)",
 label:"Economia",
 ...
 key:"scienze", accent:"hsl(145 28% 34%)",
 label:"Scienze",
 ...
 key:"letteratura", accent:"hsl(320 28% 44%)",
 label:"Letteratura",
 ...
 key:"filosofia", accent:"hsl(230 22% 44%)",
 label:"Filosofia",
 ...
 key:"fisica", accent:"hsl(185 38% 35%)",
 label:"Fisica",
 ...
 key:"informatica", accent:"hsl(250 28% 47%)",
 label:"Informatica",
 ...
 key:"geografia", accent:"hsl(85 26% 34%)",
 label:"Geografia",
 ...
 key:"diritto", accent:"hsl(220 16% 38%)",
 label:"Diritto",
 ...
 key:"lingue", accent:"hsl(28 50% 42%)",
 label:"Lingue",
 ...
 *
 * P29 — l'inchiostro chiaro è la panna #F8F7DD (non più il bianco puro):
 * stessa scelta di contrasto, tinta calda coerente con il resto di Erga.
 */
export function getAccentForeground(accent: string): "#F8F7DD" | "#111111" {
 ...
 const creamLuminance = 0.917; // #F8F7DD
 const creamContrast = (creamLuminance + 0.05) / (luminance + 0.05);
 const darkLuminance = 0.0056; // #111111
 const darkContrast = (luminance + 0.05) / (darkLuminance + 0.05);
 return creamContrast >= darkContrast ? "#F8F7DD" : "#111111";
}
