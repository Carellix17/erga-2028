...
const SUBJECT_COLORS: SubjectColor[] = [
 ...
 border:"border-amber-200", icon:"bg-amber-100", gradient:"from-amber-500 to-orange-500", solid:"bg-amber-500",
 ...
 border:"border-blue-200", icon:"bg-blue-100", gradient:"from-blue-500 to-indigo-600", solid:"bg-blue-600",
 ...
 border:"border-emerald-200", icon:"bg-emerald-100", gradient:"from-emerald-500 to-green-600", solid:"bg-emerald-600",
 ...
 border:"border-teal-200", icon:"bg-teal-100", gradient:"from-teal-500 to-cyan-600", solid:"bg-teal-600",
 ...
 border:"border-rose-200", icon:"bg-rose-100", gradient:"from-rose-500 to-pink-600", solid:"bg-rose-500",
 ...
 border:"border-violet-200", icon:"bg-violet-100", gradient:"from-violet-500 to-purple-600", solid:"bg-violet-600",
 ...
 border:"border-sky-200", icon:"bg-sky-100", gradient:"from-sky-500 to-blue-500", solid:"bg-sky-600",
 ...
 border:"border-cyan-200", icon:"bg-cyan-100", gradient:"from-cyan-500 to-teal-500", solid:"bg-cyan-600",
 ...
 border:"border-fuchsia-200", icon:"bg-fuchsia-100", gradient:"from-fuchsia-500 to-pink-500", solid:"bg-fuchsia-600",
 ...
 border:"border-lime-200", icon:"bg-lime-100", gradient:"from-lime-500 to-green-500", solid:"bg-lime-600",
 ...
 border:"border-slate-200", icon:"bg-slate-100", gradient:"from-slate-500 to-gray-600", solid:"bg-slate-600",
 ...
 border:"border-orange-200", icon:"bg-orange-100", gradient:"from-orange-500 to-red-500", solid:"bg-orange-500",
...
const DEFAULT_COLOR: SubjectColor = {
 ...
 border:"border-indigo-200", icon:"bg-indigo-100", gradient:"from-primary to-secondary", solid:"bg-black",
