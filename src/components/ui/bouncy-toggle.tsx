...
interface PremiumToggleProps {
  ...
  label?: string
  /**
   * Nome accessibile dell'interruttore. Erga richiede un nome per ogni
   * controllo senza testo proprio (AGENTS.md §4): senza, uno screen reader
   * annuncia solo "commutatore" senza dire cosa si sta accendendo.
   */
  "aria-label"?: string
}

export function PremiumToggle({ defaultChecked = false, onChange, label, "aria-label": ariaLabel }: PremiumToggleProps) {
