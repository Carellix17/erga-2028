        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-1 flex-wrap">
            ...
            {evaluation.goal != null && (
              <span className="label-small px-2.5 py-0.5 rounded-full bg-neutral-100 text-neutral-800 dark:bg-neutral-900/50 dark:text-cream inline-flex items-center gap-1">
