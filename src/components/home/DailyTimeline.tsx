...
export function DailyTimeline({
  ...
  if (tasks.length === 0) {
    return (
      <section className="rounded-card border border-border glass-tactile p-5 shadow-tactile">
  ...
  return (
    <section className="overflow-hidden rounded-card border border-border glass-tactile shadow-tactile">
