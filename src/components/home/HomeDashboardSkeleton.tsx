    ...
    >
      ...
      <header className="mb-4 flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1 space-y-2">
          <Skeleton className="h-[2.85rem] w-3/5 rounded-button sm:h-[4.625rem] md:h-[5rem] lg:h-[5.7rem]" />
          <Skeleton className="h-[2.85rem] w-2/5 rounded-button sm:h-[4.625rem] md:h-[5rem] lg:h-[5.7rem]" />
