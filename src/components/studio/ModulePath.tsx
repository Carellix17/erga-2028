      ...
      <div className="relative mx-2 mt-5" style={{ height }}>
        ...
        {modLessons.map(({ lesson, globalIndex }, i) => {
          ...
          return (
            ...
            >
              ...
              >
                <div className="rounded-xl bg-white/15 dark:bg-[#F8F7DD]/10 backdrop-blur-sm border border-white/30 dark:border-[#F8F7DD]/15 shadow-level-1 px-3 py-1.5">
        ...
        >
          ...
          <div className="absolute top-[calc(100%+14px)] left-1/2 -translate-x-1/2 z-10 whitespace-nowrap">
            <div className="rounded-xl bg-white/15 dark:bg-[#F8F7DD]/10 backdrop-blur-sm border border-white/30 dark:border-[#F8F7DD]/15 shadow-level-1 px-3 py-1 text-center">
      ...
      {allDone && (
        <div className="px-4 mt-14">
          <button
            ...
            className="w-full h-12 rounded-full bg-black text-white font-semibold text-sm transition-all duration-200 hover:bg-neutral-800 active:scale-[0.97] dark:bg-[#F8F7DD] dark:text-black dark:hover:bg-[#EDECD0]"
          >
