...
// Box-citazioni: tre pastelli + neutro, ciascuno con la sua versione notturna.
const CALLOUT_VARIANTS = {
  yellow: "bg-amber-100/80 dark:bg-amber-950/40 border-amber-300/70 dark:border-amber-800/40 text-amber-950 dark:text-amber-100",
  pink: "bg-rose-100/80 dark:bg-rose-950/40 border-rose-300/70 dark:border-rose-800/40 text-rose-950 dark:text-rose-100",
  blue: "bg-sky-100/80 dark:bg-sky-950/40 border-sky-300/70 dark:border-sky-800/50 text-sky-950 dark:text-sky-100",
...
function CalloutBlockquote({ children }: { children?: React.ReactNode }) {
  ...
  return (
    <div
      className={cn(
        "my-3 px-4 py-3 rounded-2xl border body-medium leading-relaxed [&>p]:m-0 [&_strong]:font-semibold",
